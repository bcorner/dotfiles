...
(use-package gh
  :defer t
  :elpaca (gh :type git :host github :repo "IvanMalison/gh.el"))
#+END_SRC
*** parse-csv
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package emit
	:commands imalison:shell-command-on-region
	:config
...
#+BEGIN_SRC emacs-lisp
  (defvar imalison:use-frame-mode
    (not (null (string-match "xmonad" (shell-command-to-string "wmctrl -m")))))
...
(use-package purty
  ...
  :elpaca (purty :repo "joneshf/purty"
                   :type git
                   :host gitlab
                   :files ("purty.el")))
...
(use-package org-fc
  ...
  :elpaca (org-fc :type git :host github :repo "l3kn/org-fc"
...
#+BEGIN_SRC emacs-lisp
(use-package tex
  :elpaca (auctex :host github :repo "raxod502/auctex"
                    :branch "fork/1"
...
(mapcar (lambda (package-name) (eval `(use-package ,package-name))) packages-appearance)
